    ...
    <table style="width: 100%; border-collapse: collapse; table-layout: fixed;">
        <tr>
            ...
            <td style="width: 33%; vertical-align: center; padding-left: 40px; text-align: left;">
                <div style="text-transform: uppercase; font-size: 10px; font-weight: bold; color: white; letter-spacing: 1px; margin-bottom: 5px;">
                    Desarrollo y Arquitectura de Software
                </div>
                <div style="font-size: 24px; font-weight: 900; color: white; margin-bottom: 2px;">
                    Hernán Gabriel Menna
                </div>
            </td>

            <!-- Columna Central: Contacto -->
            <td style="width: 34%; vertical-align: center; text-align: center; color: white; font-size: 14px;">
            ...
            <td style="width: 33%; vertical-align: center; padding-right: 40px; text-align: right;">
                <div style="display: inline-block; background-color: #f3f4f6; padding: 4px 12px; border-radius: 20px; font-family: monospace; font-size: 14px; color: black; margin-bottom: 10px;">
